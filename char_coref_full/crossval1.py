...
Original file is located at
    https://colab.research.google.com/drive/1S6D-ffKDk-S7tN01gj9oDQ3KoV8pNljY
"""
...
param_grid = list(itertools.product([.275, .3, .325], [1.5, 2, 2.5],[.3, .35], [1, 1.5, 2]))
hyper_params = param_grid[:len(param_grid)//4]
