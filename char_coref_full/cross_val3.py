...
Original file is located at
    https://colab.research.google.com/drive/1nw8wReprSHKYG_qX980J8pdxUL-q01iQ
"""
...
hyper_params = param_grid[2*len(param_grid)//4:3*len(param_grid)//4]
default_params = {'dataset': 'litbank_person_only', 'mem_type' : 'learned', 'num_cells' : 20, 'top_span_ratio':0.3, 'max_span_width':20, 'max_epochs':25, 'dropout_rate' :0.3,
                  ...
                  'trainer':'james', 'delete':True, 'crossval':True}
...
best_args, best_dev, best_res = cross_val(params.keys(), hyper_params)

hyper_params = {'new_ent_wt': [ 1.9, 2,2.5], 'over_loss_wts' : [1, 1.5, 2], 'dropout': [0.25, .3, .35]}

params ={'dataset': 'litbank_person_only', 'mem_type': 'learned', 'num_cells': 20, 'top_span_ratio': 0.35, 'max_span_width': 20, 'max_epochs': 25, 'dropout_rate': 0.33, 'sample_invalid': 0.35, 'new_ent_wt': 2.1, 'cross_val_split': 3, 'max_training_segments': 5, 'seed': 0, 'mention_model': 'ment_litbank_person_only_width_20_mlp_3000_model_large_emb_attn_type_spanbert_enc_overlap_segment_512', 'trainer': 'luke', 'delete': False, 'crossval': True}
...
default_params = {'dataset': 'litbank_person_only', 'mem_type' : 'learned', 'num_cells' : 20, 'top_span_ratio':0.3, 'max_span_width':20, 'max_epochs':25, 'dropout_rate' :0.3,
                  'sample_invalid':0.25, 'new_ent_wt': 1.75, 'cross_val_split':3, 'max_training_segments':5, 'seed' :0, 'mention_model':'ment_litbank_person_only_width_20_mlp_3000_model_large_emb_attn_type_spanbert_enc_overlap_segment_512',
                  'trainer':'james', 'delete':True, 'crossval':True}
hyper_params = {'new_ent_wt' : [1.75],'over_loss_wts' : [1.5, 2, 3, 5, 7]}
