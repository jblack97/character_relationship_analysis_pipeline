...
Original file is located at
    https://colab.research.google.com/drive/1vsj_XOwXkOQiT6xJy7lb5u6L3K5tj1Vh
"""
...
hyper_params = param_grid[3*len(param_grid)//4:]
default_params = {'dataset': 'litbank_person_only', 'mem_type' : 'learned', 'num_cells' : 20, 'top_span_ratio':0.3, 'max_span_width':20, 'max_epochs':25, 'dropout_rate' :0.3,
                  ...
                  'trainer':'nish', 'delete':True, 'crossval':True}
